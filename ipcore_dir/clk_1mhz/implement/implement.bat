...
xst -ifn xst.scr
move clk_1mhz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clk_1mhz.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_1mhz.ucf clk_1mhz_exdes

echo 'Running map'
map -timing -pr b clk_1mhz_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk_1mhz_exdes -w routed.ncd routed.vhd
cd ..
